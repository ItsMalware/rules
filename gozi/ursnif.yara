...
$str_4 = "@superWinner@0" nocase wide ascii
$str_5 = "xpxxxx" fullword nocase wide ascii
...
$str_16 = "if exist %%1 goto %u" nocase wide ascii
$str_17 = "cmd /C" nocase wide ascii
$str_18 = "svchost.exe" nocase wide ascii
$str_20 = "Client" nocase wide ascii
$str_21 = "Client32" nocase wide ascii
$str_22 = "del %%0" nocase wide ascii
$str_23 = "321.txt" nocase wide ascii
$str_24 = "DllRegisterServer"
...
$bn_11 = {?? 8B 44 24 08 ?? 33 ?? ?? 83 E8 00 74 ?? 48 75 ??}
//offset_entrypoint ref has 3228
condition:
9 of ($st*) and 3 of ($bn*)
}
